...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='Xiaomi-AiOT-AX3600'' package/lean/default-settings/files/zzz-default-settings
...
# 修改默认wifi名称ssid为MIWIFIAX3600
sed -i 's/ssid=OpenWrt/ssid=MIWIFIAX3600/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
